...
public class HelloVersioningService {
	...
	@GetMapping(path = "/custom/mediatype", produces = "application/X.App.Version.v1+json")
	public PersonV1 getMediaTypeVersioningV1() {
		return new PersonV1("Vivek Singh");
	}

	@GetMapping(path = "/custom/mediatype", produces = "application/X.App.Version.v2+json")
	public PersonV2 getMediaTypeVersioningV2() {
		return new PersonV2("Vivek", "Singh");
	}
